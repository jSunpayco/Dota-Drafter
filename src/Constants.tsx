export const constants = {
    ...
    captainsModeDesc:
      "DOTA 2 is a game wherein two teams of five players match up against each other with the goal of destroying their opponent's base. Captains mode is the standard format for tournament games. Two teams start off by first picking a captain that will call the shots on which characters (called heroes) their respective team wants to play, and which they do not want to play against. Each captain then take turns banning certain heroes, up to seven per team, preventing either team from picking the hero, and also choosing five heroes for their team to utilize for the game.",
  
    howToPlay:
      'One must first pick which team gets to have the first/second pick for the game (Radiant or Dire). 30 seconds are then allotted for bans, and 30 seconds for picks as well. Each captain also has 130 seconds total bonus time that can be used throughout any selection, once their original 30 seconds has run out. If time runs out during a ban selection, no hero will be banned; if time runs out during a pick selection, a random hero will be chosen.',
